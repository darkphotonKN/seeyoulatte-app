...
import (
	...
	"github.com/darkphotonKN/seeyoulatte-app/services/order-service/config"
...
var (
	...
	serviceName    = "order"
	grpcAddr       = commonhelpers.GetEnvString("GRPC_ORDER_ADDR", "7303")
...
func main() {
	...
	slog.Info("order-service gRPC server starting", "port", grpcAddr)
