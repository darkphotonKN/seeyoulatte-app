...
import (
	...
	"github.com/darkphotonKN/seeyoulatte-app/services/baseline-service/config"
...
var (
	...
	grpcAddr       = commonhelpers.GetEnvString("GRPC_BASELINE_ADDR", "7302")
...
func main() {
	...
	broker.DeclareExchange(ch, commonconstants.BaselineEventsExchange, "topic")
	defer func() {
		closeCh()
		ch.Close()
	}()
	...
	slog.Info("baseline-service gRPC server starting", "port", grpcAddr)
